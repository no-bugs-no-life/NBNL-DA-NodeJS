    ...
    <div className="bg-transparent md:bg-white md:rounded-2xl md:overflow-hidden">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {isLoading ? (
              ...
              <DataRows tags={tags} onEdit={onEdit} onDelete={onDelete} />
            )}{" "}
          </tbody>{" "}
        </table>{" "}
      </div>{" "}
      ...
      <div className="block md:hidden space-y-4">
        ...
        {isLoading ? (
          ...
          <MobileCards tags={tags} onEdit={onEdit} onDelete={onDelete} />
        )}{" "}
      </div>{" "}
      {!isLoading && (
        <Pagination
...
function ActionButtons({
  ...
  item: TagItem;
  onEdit: (cat: TagItem) => void;
  onDelete: (cat: TagItem) => void;
  showLabels?: boolean;
}) {
  return (
    <div
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <p className="text-xs text-slate-500 mb-0.5 truncate mt-1">
                Số lượng App: {tag.appIds ? tag.appIds.length : 0}
              </p>{" "}
            </div>{" "}
          </div>{" "}
          <ActionButtons
      ...
      {tags.map((tag) => (
        ...
        >
          ...
          <td className="px-6 py-4 text-slate-600">
            {tag.appIds ? tag.appIds.length : 0}
          </td>{" "}
