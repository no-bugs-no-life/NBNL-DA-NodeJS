...
export function useAdminSubscriptions() {
	...
	const { data, isLoading } = useQuery({
		...
		queryFn: () => fetchSubscriptions({ page, limit, status: statusFilter || undefined }),
	});
	...
	const mCreate = useMutation({
		mutationFn: (data: { userId: string; appId: string; subPackageId: string }) =>
