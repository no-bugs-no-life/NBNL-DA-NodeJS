    ...
    <div className="min-h-screen w-full flex bg-surface">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12 relative z-10 min-h-screen">
        ...
        <div className="w-full max-w-md flex flex-col items-center">
          ...
          <form onSubmit={handleLogin} className="w-full flex flex-col gap-5 mb-8">
            {errorStr && (
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-on-surface-variant ml-1">Tên đăng nhập</label>
              <input
                type="text"
                value={username}
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-on-surface-variant ml-1">Mật khẩu</label>
              <input
                type="password"
                value={password}
            ...
            <div className="flex items-center justify-between mt-1">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded text-primary focus:ring-primary border-outline-variant/60" />
                <span className="text-sm text-on-surface-variant font-medium">Ghi nhớ</span>
              </label>
          ...
          <div className="flex items-center gap-4 w-full mb-8">
            ...
            <span className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Hoặc</span>
            <div className="h-[2px] flex-1 bg-surface-container-high rounded-full" />
          </div>

          {/* Google Login Button */}
          <button type="button" className="w-full flex items-center justify-center gap-3 bg-surface-container hover:bg-surface-container-high text-on-surface font-semibold py-3.5 px-4 rounded-2xl transition-all active:scale-[0.98]">
      ...
      <div className="hidden lg:flex w-1/2 bg-surface-container relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
          ...
          <div className="mt-16 text-center">
            <h2 className="text-4xl lg:text-5xl font-black text-on-surface mb-5 tracking-tight drop-shadow-sm">Khám Phá Vũ Trụ</h2>
            <p className="text-lg text-on-surface-variant font-medium max-w-sm mx-auto leading-relaxed">
              Kho ứng dụng và trò chơi đỉnh cao nhất luôn được cập nhật mỗi ngày. Sẵn sàng cho mọi cuộc chiến!
            </p>
          </div>
        </div>
      </div>
