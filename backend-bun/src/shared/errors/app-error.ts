export class AppError extends Error {
	...
	static unauthorized = (message = "Unauthorized") => new AppError(message, 401);
	static forbidden = (message = "Forbidden") => new AppError(message, 403);
	static notFound = (message = "Not found") => new AppError(message, 404);
	static conflict = (message = "Conflict") => new AppError(message, 409);
	static internal = (message = "Internal Server Error") => new AppError(message, 500, false);
}
...
export const internal = (message = "Internal Server Error") => new AppError(message, 500, false);
